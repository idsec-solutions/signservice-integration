...
/**
 * For Spring Framework users. A {@link Converter} that lets the user reference a {@link PkiCredential} instance using
 * its bean name, or if no bean is found, the signing credential name {@link PkiCredential#getName()}.
 * <p>
