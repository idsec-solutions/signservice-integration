 ...
 * (see {@link IntegrationServiceConfiguration#isStateless()}), the {@link #getEncodedState()} holds the encoded session
 * state.
 * </p>
 * 
...
public interface SignatureState extends Serializable {
   ...
   * {@link IntegrationServiceConfiguration#isStateless()}) this method returns the encoded session state.
   * 
   * <p>
